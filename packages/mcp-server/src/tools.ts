...
/** Returns the 5 standard OKP MCP tool definitions. */
export function getOKPTools(): Tool[] {
  return [
    {
...
/** Pre-built tool list for convenience (same as getOKPTools()). */
export const OKP_TOOLS: Tool[] = getOKPTools();
